    ...
    <Container ref={containerRef}>
      <SVGContainer viewBox="0 0 600 400" xmlns="http://www.w3.org/2000/svg" key={iteration}>
        ...
        <g transform="translate(200, 20)">
          ...
          <Connection d="M60 160 L90 160" $delay={1.2} />
          <ActionBlock x="90" y="130" width="200" height="60" rx="4" $delay={1.2} />
          <ActionText x="190" y="160" $delay={1.5}>Create Awesome GRAFCET Magic!</ActionText>

          {/* Connection to second transition */}
          <Connection d="M30 190 L30 220" $delay={2} />
          ...
          <Connection d="M30 230 L30 260" $delay={2.5} />
          ...
          {/* Connection back to Initial - loop */}
          <Connection d="M30 320 L30 340 L-50 340 L-50 30 L0 30" $delay={3} />
        </g>
      </SVGContainer>
    </Container>
  );
